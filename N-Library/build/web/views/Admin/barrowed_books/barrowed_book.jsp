...
<body>
    ...
    <div class="container right">
        <h2 class="my-4">New Book Borrowing</h2>
        <div class="row">
            <div class="col-md-6">
                <h3>User Details</h3>
                <form>
                    <div class="form-group">
                        ...
                        <button type="button" class="btn btn-dark mt-2">Find User</button>
                    </div>
                    <div class="form-group">
                        <label for="userName">User Name</label><input type="text" class="form-control" id="userName" disabled>
            ...
            <div class="col-md-6">
                ...
                <form action="" method="get">
                    <div class="form-group">
                        ...
                        <a type="button" class="btn btn-dark mt-2">Find Book</a>
                    </div>
                    <div class="form-group">
                        <label for="bookAvailability">Book Availability</label>
                        <input type="text" class="form-control" id="bookAvailability" value="true" disabled>
                    </div>
                    <div class="form-group">
                        <img src="book_image_url" alt="Book Image" class="img-thumbnail">
                    </div>
                    <div class="form-group">
                        <label for="bookName">Book Name</label>
                        <input type="text" class="form-control" id="bookName" disabled>
                    </div>
                    <div class="form-group">
            ...
            <div class="col-md-12">
                ...
                <form action="${pageContext.request.contextPath}/admin/barrowbooks/new" method="post">
                    ...
                    <button type="submit" class="btn btn-success">Borrow Book</button>
                     <a href="display_barrowed_books.jsp" class="btn btn-success astyle">Back</a>
                </form>
            </div>
        </div>
    </div>
