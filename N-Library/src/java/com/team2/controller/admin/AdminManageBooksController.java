...
//        processRequest(request, response);
        ...
        try {
            switch (action) {
                case "/admin/book/":
                    ...
                    break;
                case "/admin/book/new":
                    showAddNewBook(request, response);
                    break;
    ...
    private void showAddNewBook(HttpServletRequest request, HttpServletResponse response) throws SQLException, IOException, ServletException {
